...
/** Lucro/margem de uma venda avulsa (idea #4): preço vendido − custo − frete. */
...
export function Vendas() {
  ...
  return (
    <Screen
      ...
      subtitle="Registre vendas fora do padrão (preço, custo e frete manuais) — aquelas que não seguem o catálogo."
    >
